...
class M_outlet extends CI_Model{
	...
	function save_data_outlet($name,$alamat,$area,$provinsi,$kota,$pos,$telepon,$latitude,$longitude,$type){
	...
	function update_data_outlet($id,$name,$alamat,$area,$provinsi,$kota,$pos,$telepon,$latitude,$longitude,$type){
