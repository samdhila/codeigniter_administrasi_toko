	...
	<div class="main-content-inner">
		...
		<div class="page-content">
            ...
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel">Master Supplier</h3>
            </div>
            <form class="form-horizontal" id="frm" method="post" action="<?php echo base_url('admin/c_supplier/add_data');?>">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            ...
                            <input name="fld2" id="fld2" class="form-control text-uppercase" type="text" placeholder="Supplier..." required>
                        </div>
                    </div>
                </div>
