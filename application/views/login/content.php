				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
									<i class="ace-icon fa"><img src="<?php echo base_url()?>assets/images/logo.png" style="width:64px;height:64px;"></i>
									<span class="blue">Tukutuku</span>
									</br>
									<?php 
									//echo $vindex;
									?>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form role="form" id="f_login" method="post" action="#">
												<fieldset>
